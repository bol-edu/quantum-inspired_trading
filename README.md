...
* Overwrite the origional AAT Q2 files in ../Accelerated_Algorithmic_Trading/hw/pricingEngine with the files in  sbm/src/hw/pricingEngine or sqa/src/hw/pricingEngine.
